...
public class IntroLabTest {
     ...
     */
    @Test()
    public void testNguy3016() {
        String expected = "Hello there! My name is Andrew Nguyen! I like dogs more than cats! Nice to meet you!";
        String actual = IntroLab.nguy3016();
        assertEquals(expected, actual);
    }
}
